...
// TAB Names:
export const TAB1_NAME = 'Weather'
export const TAB2_NAME = 'News'
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                  <Nav className="me-auto">
                      ...
                      <NavDropdown title="More" id="basic-nav-dropdown">
                          <NavDropdown.Item as={Link} to="/weather">{TAB1_NAME}</NavDropdown.Item>
                          <NavDropdown.Item as={Link} to="/news">{TAB2_NAME}</NavDropdown.Item>
                            <NavDropdown.Divider />
