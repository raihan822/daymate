    ...
    return (
        <div>
            ...
            <ol>
                ...
                <li>Click on Generate Plan, and see your Plan for the day generated by LLM
                    <ul>
                        <li> Plan is generated on a day by considering the weather and news on the current location</li>
                    </ul>
                </li>
            </ol>
            ...
            <ul>
             ...
             <pre>
                 <strong>Quick Starter:</strong> Go to the <strong>"{TAB1_NAME}"</strong>, give permission for location access and <strong>'Generate plan'</strong> for the day.
             </pre>
         </div>
     );
}
